...
4. **Coupons/inventory are enforced server-side.** Checkout validates coupon validity + available inventory; the webhook decrements stock (floored at 0) at payment. Still missing: a coupon-entry field in the cart UI.
